...
import com.example.appmaybay1.doiTuong.KhachHang;
...
public class DialogVeMayBayDaBan extends Dialog {
    ...
    public DialogVeMayBayDaBan(@NonNull Context context, VeMayBayDaBan veMayBayDaBan) {
        ...
        gmailNguoiDung=veMayBayDaBan.getGmailKhachHang();
        anhxa();
        khoiTaoBanDau();
        txt_tenKhachHang.setText(veMayBayDaBan.getTenKhachHang().toString());
        ...
        bt_back2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context, Activity_VeDaBan.class);
    ...
    private void ganThongTinChuyenBat(VeMayBayDaBan veMayBayDaBan){
        ...
        String urlKhachHangDK=urlKhachHang+"?me="+"timkhachhang2"+"&gmail="+gmailNguoiDung+"&matKhau=";
